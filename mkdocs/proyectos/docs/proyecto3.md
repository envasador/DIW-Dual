...
**Semana 2:**
* [Fase 3 (Sistema de componentes UI)](proyecto-maquetar-para-dar-forma-fase-3.md)
...
#### **RA5.a - Necesidad accesibilidad (2.70%)**

| Criterio | Excelente (10) | Notable (8) | Aprobado (5) | Suspenso (0-4) |
|----------|----------------|-------------|--------------|----------------|
| Comprensión | DOCUMENTACION.md explica importancia detalladamente, HTML semántico en todo el proyecto, landmarks apropiados, ejemplos de beneficios | Explica importancia, HTML mayormente semántico | Menciona accesibilidad, HTML básico | Sin documentación sobre accesibilidad |

#### **RA5.b - Analizar accesibilidad (2.70%)**

| Criterio | Excelente (10) | Notable (8) | Aprobado (5) | Suspenso (0-4) |
|----------|----------------|-------------|--------------|----------------|
| Tests | Lighthouse (>90) + WAVE/axe con capturas en DOCUMENTACION.md, informe detallado, problemas identificados, antes/después | 2 herramientas, Lighthouse >85, informe presente | 1 herramienta, Lighthouse >75 | Sin tests o < 75 |

#### **RA5.c - Principios WCAG (2.70%)**

| Criterio | Excelente (10) | Notable (8) | Aprobado (5) | Suspenso (0-4) |
|----------|----------------|-------------|--------------|----------------|
| WCAG documentado | DOCUMENTACION.md identifica 4 principios WCAG, criterios nivel A cubiertos con checklist, nivel conformidad, ejemplos implementación | Identifica principios, mayoría criterios A, nivel conformidad | Menciona principios, algunos criterios A | Sin documentación WCAG |

#### **RA5.g - Verificar navegadores (2.70%)**

| Criterio | Excelente (10) | Notable (8) | Aprobado (5) | Suspenso (0-4) |
|----------|----------------|-------------|--------------|----------------|
| Testing multiplataforma | Testeado Chrome/Firefox/Safari con tabla en DOCUMENTACION.md, navegación teclado verificada, test lector pantalla documentado | Testeado 2-3 navegadores, navegación teclado, lector pantalla | Testeado 2 navegadores | 1 navegador o sin documentar |
